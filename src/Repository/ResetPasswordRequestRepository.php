...
class ResetPasswordRequestRepository extends ServiceEntityRepository implements ResetPasswordRequestRepositoryInterface
{
    ...
    public function createResetPasswordRequest(
        ...
        foreach ($resetPasswordRequests as $resetPasswordRequest) {
            $this->removeResetPasswordRequest($resetPasswordRequest);
        }
        ...
        // Utiliser la méthode publique au lieu de initialize directement
        $resetPasswordRequest->initializeRequest(
            $expiresAt,
            $selector,
            $hashedToken
        );

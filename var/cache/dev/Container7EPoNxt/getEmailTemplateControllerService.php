...
class getEmailTemplateControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\EmailTemplateController'] = $instance = new \App\Controller\EmailTemplateController(($container->privates['App\\Service\\AdminPermissionService'] ?? $container->load('getAdminPermissionServiceService')), ($container->privates['App\\Service\\EmailTemplateService'] ?? $container->load('getEmailTemplateServiceService')), ($container->privates['App\\Service\\AuditLogService'] ?? $container->load('getAuditLogServiceService')));

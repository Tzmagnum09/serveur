...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\UserPermissionsController' => 'getUserPermissionsControllerService',
            'App\\Controller\\CookieController' => 'getCookieControllerService',
            'App\\Controller\\EmailTemplateController' => 'getEmailTemplateControllerService',
            ...
            'App\\Controller\\StaticTranslationController' => 'getStaticTranslationControllerService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('security.interactive_login', [#[\Closure(name: 'App\\EventListener\\UserLocaleListener')] fn () => ($container->privates['App\\EventListener\\UserLocaleListener'] ?? $container->load('getUserLocaleListenerService')), 'onInteractiveLogin'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\UserController', 'App\\Controller\\Admin\\UserPermissionsController', 'App\\Controller\\AdminController', 'App\\Controller\\CookieController', 'App\\Controller\\EmailTemplateController', 'App\\Controller\\HomeController', 'App\\Controller\\LocaleController', 'App\\Controller\\ProfileController', 'App\\Controller\\RegistrationController', 'App\\Controller\\ResetPasswordController', 'App\\Controller\\SecurityController', 'App\\Controller\\StaticTranslationController', 'App\\Controller\\SuperAdminController', 'App\\Controller\\TermsController', 'App\\Controller\\TranslationController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['App\\EventSubscriber\\LocaleSubscriber'] = new \App\EventSubscriber\LocaleSubscriber(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), 'fr');
    }
    ...
    /**
     * Gets the private 'monolog.handler.alert_file' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_AlertFileService($container)
    {
        $container->privates['monolog.handler.alert_file'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/alert.log'), 'alert', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.critical_file' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_CriticalFileService($container)
    {
        $container->privates['monolog.handler.critical_file'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/critical.log'), 'critical', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.debug_file' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_DebugFileService($container)
    {
        $container->privates['monolog.handler.debug_file'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/debug.log'), 'debug', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.emergency_file' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_EmergencyFileService($container)
    {
        $container->privates['monolog.handler.emergency_file'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/emergency.log'), 'emergency', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.error_file' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_ErrorFileService($container)
    {
        $container->privates['monolog.handler.error_file'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/error.log'), 'error', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.info_file' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_InfoFileService($container)
    {
        $container->privates['monolog.handler.info_file'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/info.log'), 'info', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.notice_file' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_NoticeFileService($container)
    {
        $container->privates['monolog.handler.notice_file'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/notice.log'), 'notice', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.warning_file' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_WarningFileService($container)
    {
        $container->privates['monolog.handler.warning_file'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/warning.log'), 'warning', true, NULL, false);
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        return $container->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            ...
            yield 1 => ($container->privates['security.user.provider.concrete.app_username_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppUsernameProviderService'));
    ...
    protected static function getSecurity_Csrf_SameOriginTokenManagerService($container)
    {
        ...
        return $container->privates['security.csrf.same_origin_token_manager'] = new \Symfony\Component\Security\Csrf\SameOriginCsrfTokenManager($a, ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), new \Symfony\Component\Security\Csrf\CsrfTokenManager(($container->privates['security.csrf.token_generator'] ??= new \Symfony\Component\Security\Csrf\TokenGenerator\UriSafeTokenGenerator()), ($container->privates['security.csrf.token_storage'] ?? self::getSecurity_Csrf_TokenStorageService($container)), $a), ['submit', 'authenticate', 'logout'], false, 'csrf-token');
    }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'app.email_sender' => $container->getEnv('APP_EMAIL'),
            'app.domain' => $container->getEnv('APP_DOMAIN'),
            'app.email' => $container->getEnv('APP_EMAIL'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'app.sender_name' => 'Administrateur Serveur Dmqode.be',
            'app.logo_directory' => (\dirname(__DIR__, 4).'/public/images'),
            ...
            'monolog.handlers_to_channels' => [
                ...
                'monolog.handler.deprecation_file' => [
                    'type' => 'inclusive',
                    'elements' => [
                        0 => 'deprecation',
                    ],
                ],
                'monolog.handler.doctrine_file' => [
                    'type' => 'inclusive',
                    'elements' => [
                        0 => 'doctrine',
                    ],
                ],
                'monolog.handler.emergency_file' => [
                    'type' => 'exclusive',
                    'elements' => [
                        0 => 'event',
                        1 => 'doctrine',

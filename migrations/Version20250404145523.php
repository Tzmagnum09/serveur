 ...
 */
final class Version20250404145523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reset_password_request (
            ...
            UNIQUE INDEX reset_request_selector (selector), 
            PRIMARY KEY(id)
        ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

        // Création de la contrainte de clé étrangère vers la table user
